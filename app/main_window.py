...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _configure_window(self) -> None:
        """
        Configure window by adding buttons, actions on buttons, widgets, layout.
        :return: None
        """
    ...
    def _get_widgets(self) -> None:
        """
        Create widgets (buttons and labels).
        :return: None
        """
    ...
    def _add_action_on_buttons(self) -> None:
        """
        Add action functions to every button.
        :return: None
        """
    ...
    def _save_as_jpeg_action(self) -> None:
        """
        Action function on button to save statistics as jpeg file
        :return: None
        """
    ...
    def _save_as_pdf_action(self) -> None:
        """
        Action function on button to save statistics as pdf file
        :return: None
        """
    ...
    def _get_history(self) -> None:
        """
        Action function on button to get history for a date given on combo box
        :return: None
        """
    ...
    def _get_current_stats(self) -> None:
        """
        Action function on button to start getting real time statistics again
        :return: None
        """
    ...
    def _set_layout(self) -> None:
        """
        Set layout in order to add statistics and buttons
        :return: None
        """
    ...
    def _set_timer(self) -> None:
        """
        Set a timer in order to update statistics every second
        :return: None
        """
    ...
    def get_date_for_combo_box(date: int) -> str:
        """
        Transform date from timestamp int to human readable string
        :param date: Current date as integer
        :return: A string containing current date human readable
        """
