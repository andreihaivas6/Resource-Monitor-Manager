...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._dates = self._history.get_dates_on_periods()
        self._combo_box: QtWidgets.QComboBox = None
        self._index_combo_box = 0
    ...
    def _update_plot(self) -> None:
        ...
        if self._combo_box is not None and system_resources.time - self._dates[-1] >= CanvasConfig.MAX_SECONDS_ON_PLOTS:
    ...
    def _add_widgets(self) -> None:
        self._buttons.addWidget(self._now_button, 1)
        self._buttons.addWidget(self._history_button, 1)
        self._buttons.addWidget(self._combo_box, 1)
        self._buttons.addWidget(self._label, 3)
        self._buttons.addWidget(self._save_jpeg_button, 1)
        self._buttons.addWidget(self._save_pdf_button, 1)
